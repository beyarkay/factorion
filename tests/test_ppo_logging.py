...
+ pred_thput prob stashed by get_action_and_value (the policy/* metrics)."""
...
# ── per-head entropy + pred_thput prob (policy/* metrics) ──────────────────────────


class TestPerHeadEntropyStash:
    def test_get_action_and_value_stashes_head_entropy_and_pred_thput_prob(self, registered_env):
