...
@dataclass
# Best hyperparameters from W&B sweep: https://wandb.ai/beyarkay/factorion/sweeps/oghla4pt
class Args:
    ...
    learning_rate: float = 5.66336e-05
