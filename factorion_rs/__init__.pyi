...
def simulate_throughput(world: NDArray[np.int64]) -> tuple[float, int, float]: ...
...
def py_lesson_allows_orphans() -> dict[str, bool]: ...
def py_lesson_is_trial() -> dict[str, bool]: ...
def build_factory(
    size: int,
    kind: int,
    seed: int,
...
) -> tuple[NDArray[np.int64], int, list[tuple[int, int]], float] | None: ...
